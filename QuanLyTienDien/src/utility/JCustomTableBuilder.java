...
public class JCustomTableBuilder{
    ...
    public JCustomTableBuilder(JScrollPane jScrollPane){
        ...
        _jTable.getTableHeader().setBackground(new Color(255, 255, 255));
        _jTable.getTableHeader().setForeground(Color.BLACK);
        _jTable.getTableHeader().setFont(new Font("Tahoma", Font.BOLD, 14));

        _jTable.setSelectionBackground(new Color(245,245,100));
