...
public class HoTieuThuController {
    ...
    public static JPopupMenu createEditAndDeletePopUp(int rowindex, JTable table) {
        ...
        edit.setIcon(new javax.swing.ImageIcon(HoTieuThuController.class.getResource(""))); // NOI18N
        ...
        delete.setIcon(new javax.swing.ImageIcon(HoTieuThuController.class.getResource(""))); // NOI18N
